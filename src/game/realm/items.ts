...
/** the hotbar: fixed slots, keys 1-6 / LB-RB / mouse wheel */
export type HotbarSlot = 'pickaxe' | 'dirt' | 'stone' | 'wood' | 'torch' | 'potion';
export const HOTBAR: HotbarSlot[] = ['pickaxe', 'dirt', 'stone', 'wood', 'torch', 'potion'];
